...
FG.seed = (function () {
  ...
  const trucks = [
    { id: 't_101', unit_number: 'T-101', year: 2019, make: 'Kenworth', model: 'T270', vin: '1NKBLP0X8KR123456', plate: 'OH-TRK1019', type: 'Tow Truck', status: 'PM Overdue', mileage: 187420, next_pm_miles: 188000, next_pm_date: FG.utils.addDays(new Date(), -4), safety_score: 88, gvwr: 26000, color: 'White', assigned_driver_id: 'd_001', notes: 'Oil change overdue. Recovery boom unit.' },
    { id: 't_102', unit_number: 'T-102', year: 2021, make: 'Ford', model: 'F-450', vin: '1FDUF4HT6MED12345', plate: 'OH-TRK1024', type: 'Tow Truck', status: 'Active', mileage: 92110, next_pm_miles: 95000, next_pm_date: FG.utils.addDays(new Date(), 18), safety_score: 95, gvwr: 14000, color: 'Black', assigned_driver_id: 'd_002', notes: 'Light-duty wrecker.' },
    { id: 't_103', unit_number: 'T-103', year: 2020, make: 'International', model: 'MV607', vin: '1HTKHPVK7LH567890', plate: 'OH-TRK1031', type: 'Tow Truck', status: 'Flagged', mileage: 134890, next_pm_miles: 137500, next_pm_date: FG.utils.addDays(new Date(), 4), safety_score: 71, gvwr: 33000, color: 'Orange', assigned_driver_id: 'd_003', notes: '2 speeding events flagged this week.' },
    { id: 't_104', unit_number: 'T-104', year: 2022, make: 'Freightliner', model: 'M2 106', vin: '1FVACWDT4NHAA1234', plate: 'OH-TRK1042', type: 'Box Truck', status: 'Active', mileage: 56230, next_pm_miles: 60000, next_pm_date: FG.utils.addDays(new Date(), 33), safety_score: 92, gvwr: 26000, color: 'White', assigned_driver_id: 'd_004', notes: '24ft box with liftgate.' },
    { id: 't_105', unit_number: 'T-105', year: 2018, make: 'Ford', model: 'F-550', vin: '1FDUF5HT8JEA98765', plate: 'OH-TRK1053', type: 'Tow Truck', status: 'Active', mileage: 211480, next_pm_miles: 215000, next_pm_date: FG.utils.addDays(new Date(), 9), safety_score: 89, gvwr: 19500, color: 'Red', assigned_driver_id: 'd_005', notes: 'Annual inspection cert uploaded.' },
    { id: 't_106', unit_number: 'T-106', year: 2023, make: 'RAM', model: '3500', vin: '3C7WRTCJ4PG123987', plate: 'OH-TRK1067', type: 'Box Truck', status: 'Active', mileage: 28900, next_pm_miles: 35000, next_pm_date: FG.utils.addDays(new Date(), 71), safety_score: 97, gvwr: 12000, color: 'White', assigned_driver_id: null, notes: 'Newest unit. 14ft cargo.' },
    { id: 't_107', unit_number: 'T-107', year: 2021, make: 'Mack', model: 'LR Series', vin: '1M2GR4GC4MM123456', plate: 'OH-TRK1071', type: 'Box Truck', status: 'In Shop', mileage: 119840, next_pm_miles: 125000, next_pm_date: FG.utils.addDays(new Date(), 22), safety_score: 84, gvwr: 33000, color: 'Yellow', assigned_driver_id: null, notes: 'Currently at Diesel Dynamics — transmission service.' },
  ];
